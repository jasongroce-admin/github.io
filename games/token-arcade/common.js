...
function ensureTopControls(){const top=document.querySelector('.top');if(!top)return;if(!document.getElementById('adviceTopBtn')){const a=document.createElement('button');a.id='adviceTopBtn';a.className='btn';a.type='button';a.textContent='Golden Advice';a.onclick=()=>openAdvicePanel();top.appendChild(a);}if(!document.getElementById('atmTopBtn')){const b=document.createElement('button');b.id='atmTopBtn';b.className='btn';b.type='button';b.textContent='ATM';b.onclick=openAtm;top.appendChild(b);}}

function openAdvicePanel(){let panel=document.getElementById('adviceDrawer');if(!panel){panel=document.createElement('div');panel.id='adviceDrawer';panel.className='advice-drawer';panel.innerHTML="<h4>Golden Advice (Quick)</h4><p>Open full advisor tools from the Arcade home page.</p><ul><li>Roulette: track color streaks, switch after long runs.</li><li>Blackjack: follow dealer up-card strategy.</li><li>Craps: two-dice trends matter for pace bets.</li></ul><a class='btn' href='index.html'>Open Full Golden Advice</a><button class='btn' id='closeAdvice' style='margin-left:8px'>Close</button>";document.body.appendChild(panel);document.getElementById('closeAdvice').onclick=()=>panel.classList.remove('open');}panel.classList.add('open');}

function ensureArcadeDock(){if(document.getElementById('arcadeDock'))return;const d=document.createElement('div');d.id='arcadeDock';d.className='arcade-dock';d.style.display='none';d.innerHTML="";document.body.appendChild(d);const panel=document.createElement('div');panel.id='adviceDrawer';panel.className='advice-drawer';panel.innerHTML="<h4>Golden Advice (Quick)</h4><p>Open full advisor tools from the Arcade home page.</p><ul><li>Roulette: track color streaks, switch after long runs.</li><li>Blackjack: follow dealer up-card strategy.</li><li>Craps: two-dice trends matter for pace bets.</li></ul><a class='btn' href='index.html'>Open Full Golden Advice</a><button class='btn' id='closeAdvice' style='margin-left:8px'>Close</button>";document.body.appendChild(panel);}
